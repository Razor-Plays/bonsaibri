      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="md:col-span-2">
          ...
          <Input
            ...
            placeholder="e.g. Handcrafted Round Bonsai Pot"
            required
          />
        </div>
        ...
        <div>
          <Label htmlFor="price">Price (in cents, e.g. 4500 = $45)</Label>
          <Input
            id="price"
            name="price"
            type="number"
        ...
        <div>
          <Label htmlFor="material">Clay / Material</Label>
          <Input
            id="material"
            name="material"
        ...
        <div className="md:col-span-2">
          ...
          />
          {images.length > 0 && (
            <p className="text-sm text-gray-600 mt-1">{images.length} photo(s) selected</p>
          )}
        </div>
        ...
        <div className="md:col-span-2 flex items-center space-x-2">
          <input
            ...
            className="h-4 w-4"
          />
          <Label htmlFor="isFeatured">Feature this product on the home page</Label>
        </div>
      </div>
